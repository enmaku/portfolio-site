...
**Superseded in part** by [ADR 0028](./0028-movie-vote-host-phase-and-participant-quorum.md) (optional seats removed; **force-finish voting** / **host phase controls**). **Host participant removal** / **clear guests** remain **suggest phase** only.
