# Issue #383 — Map document dirty refresh regression guard

> **GitHub:** [#383](https://github.com/enmaku/portfolio-site/issues/383)  
...
This sub-plan implements [#383](https://github.com/enmaku/portfolio-site/issues/383) under epic [#354](https://github.com/enmaku/portfolio-site/issues/354). Work follows **Implement → AutoVerify → mini thermo → mini arch → Parent QA** ([REWORK-PROTOCOL.md](../REWORK-PROTOCOL.md)). Subagents **must not** close GitHub issues.
...
Copied from GitHub issue body ([#383](https://github.com/enmaku/portfolio-site/issues/383)):
...
- [ ] Every sub-sub-step (#383.1 … #383.4) complete with mini thermo **PASS**
...
- [ ] Parent QA complete — parent may close [#383](https://github.com/enmaku/portfolio-site/issues/383)
